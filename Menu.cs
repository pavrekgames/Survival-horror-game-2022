...
public class Menu : MonoBehaviour {
	...
	void Update () {
		...
		if(Input.GetButtonDown("Cancel") && isMenu == false && playerManagerScript.isPlayerCanInput == true && SceneManager.GetActiveScene().name == "ScenaGlowna" && isMenuNewGame == false && isLoadedGame == false && loadingScreenCanvas.enabled == false && isToMenu == false)
        {
			PauseGame ();
