...
public class RandomMonster : MonoBehaviour {
    ...
    void OnEnable()
    {
        ...
        point2 = GameObject.Find("Monster6Punkt1").transform;
        point3 = GameObject.Find("MonsterKorytoPunkt").transform;
        ...
        monsterMesh = GameObject.Find("Monster1_Losowy_mesh").GetComponent<SkinnedMeshRenderer>();
    ...
    void Update()
    {
        ...
        if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 1)
        {
            NavMesh.CalculatePath(monster.transform.position, point1.transform.position, -1, mainPath);
            isCalculated = false;
        }

        else if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 2)
        {
            NavMesh.CalculatePath(monster.transform.position, point2.transform.position, -1, mainPath);
            isCalculated = false;
        }

        else if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 3)
        {
            NavMesh.CalculatePath(monster.transform.position, point3.transform.position, -1, mainPath);
            isCalculated = false;
        }

        else if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 4)
        {
            NavMesh.CalculatePath(monster.transform.position, point4.transform.position, -1, mainPath);
            isCalculated = false;
        }

        else if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 5)
        {
            NavMesh.CalculatePath(monster.transform.position, point5.transform.position, -1, mainPath);
            isCalculated = false;
        }

        else if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 6)
        {
            NavMesh.CalculatePath(monster.transform.position, point6.transform.position, -1, mainPath);
            isCalculated = false;
        }

        else if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 7)
        {
            NavMesh.CalculatePath(monster.transform.position, point7.transform.position, -1, mainPath);
            isCalculated = false;
        }

        else if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 8)
        {
            NavMesh.CalculatePath(monster.transform.position, point8.transform.position, -1, mainPath);
            isCalculated = false;
        }

        else if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 9)
        {
            NavMesh.CalculatePath(monster.transform.position, point9.transform.position, -1, mainPath);
            isCalculated = false;
        }

        else if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 10)
        {
            NavMesh.CalculatePath(monster.transform.position, point10.transform.position, -1, mainPath);
            isCalculated = false;
        }

        else if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 11)
        {
            NavMesh.CalculatePath(monster.transform.position, point11.transform.position, -1, mainPath);
            isCalculated = false;
        }

        else if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 12)
        {
            NavMesh.CalculatePath(monster.transform.position, point12.transform.position, -1, mainPath);
            isCalculated = false;
        }

        else if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 13)
        {
            NavMesh.CalculatePath(monster.transform.position, point13.transform.position, -1, mainPath);
            isCalculated = false;
        }

        else if (isSawPlayer == false && isSawPlayer == false && isRayPlayer == false && isCalculated == true && randomPointIndex == 14)
        {
        ...
        if (Dystans <= 40 && Input.GetMouseButtonDown(2) && flashlightScript.isFlashlightOn == true && isSawPlayer == false && healthScript.health > 0)
        {
            isSawPlayer = true;
            monsterTime = 30f;
            firstRespawn = 0;
        ...
        if ((isSawPlayer == true || isSawPlayer == true || isRayPlayer == true || firstRespawn == 1) && Dystans >= 5 && isPathPossible == true && monsterTime > 0 && randomJumpscareScript.isPossibleTerrain == true)
        {
