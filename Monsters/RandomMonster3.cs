...
public class RandomMonster3 : MonoBehaviour {
    ...
    void OnEnable()
    {
        ...
        monster = GameObject.Find("Monster1_Losowy3").transform;
        ...
        monsterMesh = GameObject.Find("Monster1_Losowy3_mesh").GetComponent<SkinnedMeshRenderer>();
    ...
    void Update()
    {
        ...
        if (monsterTime <= 0 || randomJumpscareScript.isPossibleTerrain == false)
        {
            ...
            monster.gameObject.GetComponent<RandomMonster3>().enabled = false;
