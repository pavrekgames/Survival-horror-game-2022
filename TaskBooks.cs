...
public class TaskBooks : MonoBehaviour {
	...
	void Update () {
		...
		if (Physics.Raycast (playerAim, out hit, rayLength, 1 << 9)){
			...
			if(hit.collider.gameObject.name == "Ksiazka_motyl" && Input.GetMouseButton(0) && isBookTaken == false && isTaskDone == false && booksList.Count == 0 && inventoryScript.isPanelActive == false && inventoryScript.isInventoryActive == false && inventoryScript.isTasksActive == false && inventoryScript.isNotesActive == false && gameMenuScript.isMenu == false && inventoryScript.isTreatmentActive == false && inventoryScript.isCollectionActive == false && Time.timeScale == 1)
            {
				...
				isBookTaken = true;
			} else if(hit.collider.gameObject.name == "Ksiazka_motyl" && Input.GetMouseButtonUp(0) && isBookTaken == true && isTaskDone == false && inventoryScript.isPanelActive == false && inventoryScript.isInventoryActive == false && inventoryScript.isTasksActive == false && inventoryScript.isNotesActive == false && gameMenuScript.isMenu == false && inventoryScript.isTreatmentActive == false && inventoryScript.isCollectionActive == false && Time.timeScale == 1)
            {
		...
		if (Physics.Raycast (playerAim, out hit, rayLength, 1 << 9)){
			if(hit.collider.gameObject.name == "Ksiazka_woda" && Input.GetMouseButton(0) && isBookTaken == false && isTaskDone == false && booksList.Count == 0 && inventoryScript.isPanelActive == false && inventoryScript.isInventoryActive == false && inventoryScript.isTasksActive == false && inventoryScript.isNotesActive == false && gameMenuScript.isMenu == false && inventoryScript.isTreatmentActive == false && inventoryScript.isCollectionActive == false && Time.timeScale == 1)
            {
				...
				isBookTaken = true;
			} else if(hit.collider.gameObject.name == "Ksiazka_woda" && Input.GetMouseButtonUp(0) && isBookTaken == true && isTaskDone == false && inventoryScript.isPanelActive == false && inventoryScript.isInventoryActive == false && inventoryScript.isTasksActive == false && inventoryScript.isNotesActive == false && gameMenuScript.isMenu == false && inventoryScript.isTreatmentActive == false && inventoryScript.isCollectionActive == false && Time.timeScale == 1)
            {
				bookPositionContainer.transform.position = new Vector3(booksList[0].transform.position.x, booksList[0].transform.position.y, booksList[0].transform.position.z);
		...
		if (Physics.Raycast (playerAim, out hit, rayLength, 1 << 9)){
			if(hit.collider.gameObject.name == "Ksiazka_komputer" && Input.GetMouseButton(0) && isBookTaken == false && isTaskDone == false && booksList.Count == 0 && inventoryScript.isPanelActive == false && inventoryScript.isInventoryActive == false && inventoryScript.isTasksActive == false && inventoryScript.isNotesActive == false && gameMenuScript.isMenu == false && inventoryScript.isTreatmentActive == false && inventoryScript.isCollectionActive == false && Time.timeScale == 1)
            {
				...
				isBookTaken = true;
			} else 	if(hit.collider.gameObject.name == "Ksiazka_komputer" && Input.GetMouseButtonUp(0) && isBookTaken == true && isTaskDone == false && inventoryScript.isPanelActive == false && inventoryScript.isInventoryActive == false && inventoryScript.isTasksActive == false && inventoryScript.isNotesActive == false && gameMenuScript.isMenu == false && inventoryScript.isTreatmentActive == false && inventoryScript.isCollectionActive == false && Time.timeScale == 1)
            {
				bookPositionContainer.transform.position = new Vector3(booksList[0].transform.position.x, booksList[0].transform.position.y, booksList[0].transform.position.z);
		...
		if (Physics.Raycast (playerAim, out hit, rayLength, 1 << 9)){
			if(hit.collider.gameObject.name == "Ksiazka_kosmos" && Input.GetMouseButton(0) && isBookTaken == false && isTaskDone == false && booksList.Count == 0 && inventoryScript.isPanelActive == false && inventoryScript.isInventoryActive == false && inventoryScript.isTasksActive == false && inventoryScript.isNotesActive == false && gameMenuScript.isMenu == false && inventoryScript.isTreatmentActive == false && inventoryScript.isCollectionActive == false && Time.timeScale == 1)
            {
				...
				isBookTaken = true;
			} else if(hit.collider.gameObject.name == "Ksiazka_kosmos" && Input.GetMouseButtonUp(0) && isBookTaken == true && isTaskDone == false && inventoryScript.isPanelActive == false && inventoryScript.isInventoryActive == false && inventoryScript.isTasksActive == false && inventoryScript.isNotesActive == false && gameMenuScript.isMenu == false && inventoryScript.isTreatmentActive == false && inventoryScript.isCollectionActive == false && Time.timeScale == 1)
            {
				bookPositionContainer.transform.position = new Vector3(booksList[0].transform.position.x, booksList[0].transform.position.y, booksList[0].transform.position.z);
